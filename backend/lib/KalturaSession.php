...
class KalturaSession
{
	...
	static protected $secretRepository = null;
	...
	{
		$adminSecret = self::getSecret($this->partner_id);
		if (!$adminSecret)
			return null;
	...
	protected function logError($msg)
	{
        ...
        {
                self::$secretRepository = $repo;
        }

        static public function getSecret($partnerId)
        {
                return self::$secretRepository->getSecret($partnerId);
        }
	...
	public function parseKsV2($ks)
	{
		...
		$adminSecret = self::getSecret($partnerId);
		if (!$adminSecret)
		{
